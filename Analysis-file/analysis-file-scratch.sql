------------------------------
-- regex for Notepad++ putting the extra case statement in:
-- note you need to replace the outer double quotes with the outer single quotes used below.
---------
-- starters, jobId IN:
'(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; IN \()([\d,]+)(\) AND &quot;JobType&quot; = &apos;Starters&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)'
'CASE WHEN &quot;StartersValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5'
-- starters, jobId =:
'(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; = )([\d]+)( AND &quot;JobType&quot; = &apos;Starters&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)'
'CASE WHEN &quot;StartersValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5'
-- Leavers, jobId IN:
'(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; IN \()([\d,]+)(\) AND &quot;JobType&quot; = &apos;Leavers&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)'
'CASE WHEN &quot;LeaversValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5'
-- Leavers, jobId =:
'(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; = )([\d]+)( AND &quot;JobType&quot; = &apos;Leavers&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)'
'CASE WHEN &quot;LeaversValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5'
-- Vacancies, jobId IN:
'(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; IN \()([\d,]+)(\) AND &quot;JobType&quot; = &apos;Vacancies&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)'
'CASE WHEN &quot;VacanciesValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5'
-- Vacancies, jobId =:
'(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; = )([\d]+)( AND &quot;JobType&quot; = &apos;Vacancies&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)'
'CASE WHEN &quot;VacanciesValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5'
-- This is what these look like in Notepad config (in C:\Users\CLARE\Dropbox\IT Training\Misc\SampleNotepad++Macros.xml):

        <Macro name="analysis-starters-in" Ctrl="no" Alt="no" Shift="no" Key="0">
			<!-- The next section does a Replace All using regEx -->
			<!-- Will replace this... -->
			<!-- COALESCE((SELECT SUM("Total") FROM "EstablishmentJobs" WHERE "EstablishmentID" = e."EstablishmentID" AND "JobID" IN (27,18,23,4,24,17) AND "JobType" = 'Starters'),-1) jr30strt, --****COALESCE**** -->
			<!-- ...with this: -->
			<!-- CASE WHEN "StartersValue" = 'None' THEN 0 ELSE COALESCE((SELECT SUM("Total") FROM "EstablishmentJobs" WHERE "EstablishmentID" = e."EstablishmentID" AND "JobID" IN (27,18,23,4,24,17) AND "JobType" = 'Starters'),-1) END jr30strt, --****COALESCE**** -- 085 -->
        ...
        <Macro name="analysis-starters-equals" Ctrl="no" Alt="no" Shift="no" Key="0">
			<!-- The next section does a Replace All using regEx -->
			<!-- Does the same as analysis-starters-in but looks for "JobID" = 26 instead of "JobID" IN (27,18,23,4,24,17) -->
            <Action type="3" message="1700" wParam="0" lParam="0" sParam="" />
            <Action type="3" message="1601" wParam="0" lParam="0" sParam='(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; = )([\d]+)( AND &quot;JobType&quot; = &apos;Starters&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)' />
            <Action type="3" message="1625" wParam="0" lParam="2" sParam="" />
            <Action type="3" message="1602" wParam="0" lParam="0" sParam='CASE WHEN &quot;StartersValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5' />
            <Action type="3" message="1702" wParam="0" lParam="768" sParam="" />
            <Action type="3" message="1701" wParam="0" lParam="1609" sParam="" />
        </Macro>
        <Macro name="analysis-leavers-in" Ctrl="no" Alt="no" Shift="no" Key="0">
			<!-- The next section does a Replace All using regEx -->
			<!-- Does the same as analysis-starters-in but looks for Leavers instead of Starters -->
            <Action type="3" message="1700" wParam="0" lParam="0" sParam="" />
            <Action type="3" message="1601" wParam="0" lParam="0" sParam='(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; IN \()([\d,]+)(\) AND &quot;JobType&quot; = &apos;Leavers&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)' />
            <Action type="3" message="1625" wParam="0" lParam="2" sParam="" />
            <Action type="3" message="1602" wParam="0" lParam="0" sParam='CASE WHEN &quot;LeaversValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5' />
            <Action type="3" message="1702" wParam="0" lParam="768" sParam="" />
            <Action type="3" message="1701" wParam="0" lParam="1609" sParam="" />
        </Macro>
        <Macro name="analysis-leavers-equals" Ctrl="no" Alt="no" Shift="no" Key="0">
			<!-- The next section does a Replace All using regEx -->
			<!-- Does the same as analysis-starters-equals but looks for Leavers instead of Starters -->
            <Action type="3" message="1700" wParam="0" lParam="0" sParam="" />
            <Action type="3" message="1601" wParam="0" lParam="0" sParam='(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; = )([\d]+)( AND &quot;JobType&quot; = &apos;Leavers&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)' />
            <Action type="3" message="1625" wParam="0" lParam="2" sParam="" />
            <Action type="3" message="1602" wParam="0" lParam="0" sParam='CASE WHEN &quot;LeaversValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5' />
            <Action type="3" message="1702" wParam="0" lParam="768" sParam="" />
            <Action type="3" message="1701" wParam="0" lParam="1609" sParam="" />
        </Macro>
        <Macro name="analysis-vacancies-in" Ctrl="no" Alt="no" Shift="no" Key="0">
			<!-- The next section does a Replace All using regEx -->
			<!-- Does the same as analysis-starters-in but looks for Vacancies instead of Starters -->
            <Action type="3" message="1700" wParam="0" lParam="0" sParam="" />
            <Action type="3" message="1601" wParam="0" lParam="0" sParam='(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; IN \()([\d,]+)(\) AND &quot;JobType&quot; = &apos;Vacancies&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)' />
            <Action type="3" message="1625" wParam="0" lParam="2" sParam="" />
            <Action type="3" message="1602" wParam="0" lParam="0" sParam='CASE WHEN &quot;VacanciesValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5' />
            <Action type="3" message="1702" wParam="0" lParam="768" sParam="" />
            <Action type="3" message="1701" wParam="0" lParam="1609" sParam="" />
        </Macro>
        <Macro name="analysis-vacancies-equals" Ctrl="no" Alt="no" Shift="no" Key="0">
			<!-- The next section does a Replace All using regEx -->
			<!-- Does the same as analysis-starters-equals but looks for Vacancies instead of Starters -->
            <Action type="3" message="1700" wParam="0" lParam="0" sParam="" />
            <Action type="3" message="1601" wParam="0" lParam="0" sParam='(COALESCE\(\(SELECT SUM\(&quot;Total&quot;\) FROM &quot;EstablishmentJobs&quot; WHERE &quot;EstablishmentID&quot; = e.&quot;EstablishmentID&quot; AND &quot;JobID&quot; = )([\d]+)( AND &quot;JobType&quot; = &apos;Vacancies&apos;\),-1\) )([\w]*)(\, --\*\*\*\*COALESCE\*\*\*\*)' />
            <Action type="3" message="1625" wParam="0" lParam="2" sParam="" />
            <Action type="3" message="1602" wParam="0" lParam="0" sParam='CASE WHEN &quot;VacanciesValue&quot; = &apos;None&apos; THEN 0 ELSE $1$2$3END $4$5' />
            <Action type="3" message="1702" wParam="0" lParam="768" sParam="" />
            <Action type="3" message="1701" wParam="0" lParam="1609" sParam="" />
